...
ActiveRecord::Schema.define(version: 2021_08_25_104808) do
  ...
  create_table "friend_ships", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_1_id"], name: "index_friend_ships_on_user_1_id"
    t.index ["user_2_id"], name: "index_friend_ships_on_user_2_id"
  end
  ...
  create_table "photos", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["owner_type", "owner_id"], name: "index_photos_on_owner"
  end
  ...
  add_foreign_key "friend_ships", "users", column: "user_1_id"
  add_foreign_key "friend_ships", "users", column: "user_2_id"
